...
class EnvironmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create environment" do
    assert_difference('Environment.count') do
      post environments_url, params: { environment: { category: @environment.category, description: @environment.description, environment_type: @environment.environment_type, name: @environment.name, uid: @environment.uid } }
    end
  ...
  test "should update environment" do
    patch environment_url(@environment), params: { environment: { category: @environment.category, description: @environment.description, environment_type: @environment.environment_type, name: @environment.name, uid: @environment.uid } }
